...
class TicketController {
  ...
  async uploadTcc(req, res) {
    try {
      const arquivo = await ticketService.uploadTccFile(
        Number(req.params.id),
        req.file
      )
  ...
  async uploadFeedbackFile(req, res) {
    try {
      const arquivo = await ticketService.uploadFeedbackFile(
        Number(req.params.id),
        req.file,
        req.body
      )
